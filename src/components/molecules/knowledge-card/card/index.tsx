...
const index = ({ icon: Icon, title, text }: { icon: LucideIcon, title: string, text: string }) => {
    return (
        <div className="bg-white flex flex-col items-center p-4 rounded-lg shadow-md w-auto h-auto group transition duration-200 hover:shadow-2xl ease-out cursor-default">
